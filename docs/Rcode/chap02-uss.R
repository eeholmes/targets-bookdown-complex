...
## ----uss-stan-ar-level-ggplot, fig.cap="Estimated level and 95 percent credible intervals. Dots are the actual Nile River levels."----
library(ggplot2)
...
## ----child = file.path(here::here(), "chapters", "chap02-uss", "problems.Rmd")----
